...
train_filelist_path = params_exp_1.train_filelist_path
valid_filelist_path = params_exp_1.valid_filelist_path
cmudict_path = params_exp_1.cmudict_path
add_blank = params_exp_1.add_blank
n_spks = params_exp_1.n_spks
spk_emb_dim = params_exp_1.spk_emb_dim
n_emotions = params_exp_1.n_emotions
emotion_emb_dim = params_exp_1.emotion_emb_dim

log_dir = params_exp_1.log_dir
n_epochs = params_exp_1.n_epochs
batch_size = params_exp_1.batch_size
out_size = params_exp_1.out_size
learning_rate = params_exp_1.learning_rate
random_seed = params_exp_1.seed

nsymbols = len(symbols) + 1 if add_blank else len(symbols)
n_enc_channels = params_exp_1.n_enc_channels
filter_channels = params_exp_1.filter_channels
filter_channels_dp = params_exp_1.filter_channels_dp
n_enc_layers = params_exp_1.n_enc_layers
enc_kernel = params_exp_1.enc_kernel
enc_dropout = params_exp_1.enc_dropout
n_heads = params_exp_1.n_heads
window_size = params_exp_1.window_size

n_feats = params_exp_1.n_feats
n_fft = params_exp_1.n_fft
sample_rate = params_exp_1.sample_rate
hop_length = params_exp_1.hop_length
win_length = params_exp_1.win_length
f_min = params_exp_1.f_min
f_max = params_exp_1.f_max

dec_dim = params_exp_1.dec_dim
beta_min = params_exp_1.beta_min
beta_max = params_exp_1.beta_max
pe_scale = params_exp_1.pe_scale
...
if __name__ == "__main__":
    ...
    for epoch in range(1, n_epochs + 1):
        ...
        if epoch % params_exp_1.save_every > 0:
            continue
